...
import com.example.crud.model.NoteDao
...
abstract class MyDatabase : RoomDatabase() {
    //Kita daftarkan interface NoteDao
    ...
    companion object {
        ...
        fun getDatabase(context: Context): MyDatabase {
            ...
            synchronized(this) {
                //databaseBuilder merupakan proses membuat noteData_database
                val instance = Room.databaseBuilder(context.applicationContext, MyDatabase::class.java, "noteData_database")
